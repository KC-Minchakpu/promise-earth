      ...
      <div className={styles.content}>
        <div className={styles.inner}>
          ...
          <p className={styles.intro}>
            At Promise Earth Mining and Quarry, we are committed to responsible extraction of the 
            Earth&apos;s resources while promising a sustainable future. We are a company built on the 
