...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    text:
      "Outstanding craftsmanship and attention to detail. The team delivered exactly what was promised.",
    date: "February 21, 2025",
  },
];

export default function TestimonialSlider() {
  // Each slide shows TWO testimonials
  ...
  return (
    <section className={styles.wrapper}>
      <button className={styles.arrowLeft} onClick={prev} aria-label="Previous testimonials">
        ‹
      </button>
      ...
      <button className={styles.arrowRight} onClick={next} aria-label="Next testimonials">
        ›
      </button>
    </section>
  );
