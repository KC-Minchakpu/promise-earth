      ...
      <div className={styles.container}>
        ...
        <div className={styles.colBrand}>
          <div className={styles.logoRow}>
            ...
            <div>
              <div className={styles.brand}>Great House</div>
              <div className={styles.subBrand}>ENGINEERING COMPANY</div>
            </div>
          </div>
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.links}>
            <li><Link href="/sectors" className={styles.link}>Sectors</Link></li>
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.links}>
            <li><Link href="/services/project-management" className={styles.link}>Project Management</Link></li>
            <li><Link href="/services/design-build" className={styles.link}>Design & Build</Link></li>
            <li><Link href="/services/remodeling" className={styles.link}>Remodeling</Link></li>
