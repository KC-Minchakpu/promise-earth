    ...
    <section className={styles.section}>
      <div className={styles.card}>
        ...
        <p className={styles.text}>
          ...
          growth, uphold the highest standards of environmental stewardship and community engagement, and 
      ...
      <div className={styles.card}>
        ...
        <p className={styles.text}>
          ...
          ensure our operations benefit the region for generations to come, and We invest in cutting-edge 
